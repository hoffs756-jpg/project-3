...
const themes = {
  sunny: {
    word: 'Luminous',
    desc: 'The city breathes gold today. Light falls clean against glass and steel, warmth rises from the pavement.',
  ...
  cloudy: {
    word: 'Overcast',
    desc: 'A soft grey ceiling muffles the skyline. The city hums lower, people move with intention, wrapped in muted light.',
  ...
  rainy: {
    word: 'Rain',
    desc: 'Drops tap against the window. The streets reflect headlights and neon. Everything smells like earth and iron.',
  ...
  snowy: {
    word: 'Snow',
    desc: 'Silence descends with every flake. The city softens at its edges, corners blurred, sound absorbed by white.',
  ...
  clear: {
    word: 'Clear',
    desc: 'The sky opens wide and blue. Horizons stretch further today. Something feels possible in air this clean.',
  ...
  stormy: {
    word: 'Storming',
    desc: 'The atmosphere tightens before each rumble. Static charges the air. The city braces, awake and electric.',
